...
> [`Certificate of Completion`](https://github.com/gizellemanu/Bookmark-Manager-Website/blob/main/CertificateTailwind.jpg)
...
> [`Certificado de Conclusão`](https://github.com/gizellemanu/Bookmark-Manager-Website/blob/main/Certificado.jpg)
...
1. **Instale o Visual Studio Code**: Se você não tiver o VSCode instalado, [baixe-o aqui](https://code.visualstudio.com/).
